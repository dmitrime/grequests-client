...
def test_url_sub_params():
    ...
    assert Client(template, params).url == 'http://www.foo.com/mybar/ubaz/bam?foo=onefoo'
...
def test_url_no_sub():
    ...
    params = {'foo': 'bar', 'x': 'y'}
    assert Client(template, params).url == 'http://www.foo.com?foo=bar&x=y'
...
def test_url_params_empty():
    ...
    template = 'http://www.foo.com'
    params = {}
    assert Client(template, params).url == 'http://www.foo.com'
